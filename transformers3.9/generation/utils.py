...
class GenerationMixin:
    ...
    def generate(
        ...
        negative_prompt_ids: Optional[torch.Tensor] = None,
        negative_prompt_attention_mask: Optional[torch.Tensor] = None,
        deactivation_params: Optional[dict] = None,
        **kwargs,
        ...
        if generation_mode == GenerationMode.ASSISTED_GENERATION:
            ...
            if deactivation_params is not None:
                print("Deactivating, ", len(deactivation_params["activate_keys_fwd_down_set"][0]), type(deactivation_params["activate_keys_fwd_down_set"][0]), "; Early Exiting", candidate_premature_layers)
                #hidden_states, result, activate_keys_fwd_up, activate_keys_fwd_down, activate_keys_q, activate_keys_k, activate_keys_v, activate_keys_o, layer_keys 
                result, hidden_states, activate_keys_fwd_up, activate_keys_fwd_down, activate_keys_q, activate_keys_k, activate_keys_v, activate_keys_o, layer_keys = self._sample(
                    ...
                    activate_keys_k_set=deactivation_params['activate_keys_k_set'],
                    activate_keys_v_set=deactivation_params['activate_keys_v_set'], 
                    under_layer=deactivation_params['under_layer'], 
                    gen_layer=deactivation_params['gen_layer'], 
                    atten_number=deactivation_params['atten_number'],
                    ffn_number=deactivation_params['ffn_number'],
                    whether_under=deactivation_params['whether_under'],
                    whether_reason=deactivation_params['whether_reason'],
                    whether_gen=deactivation_params['whether_gen'],
                    whether_under_fwd=deactivation_params['whether_under_fwd'],
                    whether_reason_fwd=deactivation_params['whether_reason_fwd'],
                    whether_gen_fwd=deactivation_params['whether_gen_fwd'],
                    **model_kwargs,
                )
            else:
                print("Not deactivating", "; Early Exiting", candidate_premature_layers)
                #hidden_states, result, activate_keys_fwd_up, activate_keys_fwd_down, activate_keys_q, activate_keys_k, activate_keys_v, activate_keys_o, layer_keys 
                result, hidden_states, activate_keys_fwd_up, activate_keys_fwd_down, activate_keys_q, activate_keys_k, activate_keys_v, activate_keys_o, layer_keys = self._sample(
                    input_ids,
                    candidate_premature_layers=candidate_premature_layers,
        ...
        if candidate_premature_layers is not None:
            ret = {
                "fwd_up" : activate_keys_fwd_up,
                "fwd_down" : activate_keys_fwd_down,
                "attn_q" : activate_keys_q,
                "attn_k" : activate_keys_k,
                "attn_v" : activate_keys_v,
                "attn_o": activate_keys_o
            }
            return hidden_states, result, ret, layer_keys
        else:
            return result
            ...
            if candidate_premature_layers is not None:
                if is_prefill:
                    logits_dict, outputs, activate_keys_fwd_up, activate_keys_fwd_down, activate_keys_q, activate_keys_k, activate_keys_v, activate_keys_o, layer_keys = self(early_exit_layers=candidate_premature_layers, **model_inputs,
                        ...
                        whether_gen_fwd=whether_gen_fwd,  return_dict=True)
                    is_prefill = False
                else:
                ...
                #print("forward without early exit")
                if is_prefill:
            ...
            if return_dict_in_generate:
                if self.config.is_encoder_decoder:
                    return GenerateEncoderDecoderOutput(
                        ...
                        decoder_hidden_states=decoder_hidden_states,
                        past_key_values=model_kwargs.get("past_key_values"),
                    ), hidden_token_cont, activate_keys_fwd_up, activate_keys_fwd_down, activate_keys_q, activate_keys_k, activate_keys_v, activate_keys_o, layer_keys
                else:
                    return GenerateDecoderOnlyOutput(
                        sequences=input_ids,
                        scores=scores,
                ...
                return input_ids, hidden_token_cont, activate_keys_fwd_up, activate_keys_fwd_down, activate_keys_q, activate_keys_k, activate_keys_v, activate_keys_o, layer_keys
        else:
            if return_dict_in_generate:
                if self.config.is_encoder_decoder:
                    return GenerateEncoderDecoderOutput(
